...
func (m *MockReader) Get(id uuid.UUID) (*entity.User, error) {
	m.ctrl.T.Helper()
...
func (m *MockReader) GetByEmail(email string) (*entity.User, error) {
	m.ctrl.T.Helper()
...
func (m *MockWriter) Create(e *entity.User) (uuid.UUID, error) {
	m.ctrl.T.Helper()
...
func (m *MockWriter) Delete(id uuid.UUID) error {
	m.ctrl.T.Helper()
...
// Create mocks base method.
func (m *MockRepository) Create(e *entity.User) (uuid.UUID, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Create", e)
	ret0, _ := ret[0].(uuid.UUID)
	ret1, _ := ret[1].(error)
...
// Get mocks base method.
func (m *MockRepository) Get(id uuid.UUID) (*entity.User, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Get", id)
	ret0, _ := ret[0].(*entity.User)
	ret1, _ := ret[1].(error)
...
func (m *MockUseCase) CreateUser(email, password, firstName, lastName string) (uuid.UUID, error) {
	m.ctrl.T.Helper()
...
func (m *MockUseCase) DeleteUser(id uuid.UUID) error {
	m.ctrl.T.Helper()
...
func (m *MockUseCase) GetUser(id uuid.UUID) (*entity.User, error) {
	m.ctrl.T.Helper()
...
func (m *MockUseCase) GetUserByEmail(email string) (*entity.User, error) {
	m.ctrl.T.Helper()
...
func (mr *MockUseCaseMockRecorder) GetUserByEmail(email interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetUserByEmail", reflect.TypeOf((*MockUseCase)(nil).GetUserByEmail), email)
}
